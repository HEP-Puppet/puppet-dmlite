class dmlite::dome::params (
  ...
  $ns_oidc_allowissuer = hiera('dmlite::dav::params::ns_oidc_allowissuer', ['"/dpm" "https://wlcg.cloud.cnaf.infn.it/" wlcg'])
  $ns_oidc_allowaudience = hiera('dmlite::dav::params::ns_oidc_allowaudience', ['https://wlcg.cern.ch/jwt/v1/any'])
